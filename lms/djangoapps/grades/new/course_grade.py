...
class CourseGrade(object):
    ...
    def __init__(self, student, course, course_structure):
        ...
        # TODO: currently, data model requires a course version, but tests don't always provide one. Determine solution
        if not hasattr(self.course, 'version') or self.course.course_version is None:
